...
import threading
LAST_FRAME_BGR = None
LAST_FRAME_LEFT_BGR = None
LAST_FRAME_LEFT_TS = 0.0
...
def get_last_frame_left_bgr():
    global LAST_FRAME_LEFT_BGR
    try:
        return LAST_FRAME_LEFT_BGR.copy() if LAST_FRAME_LEFT_BGR is not None else None
    except Exception:
        return LAST_FRAME_LEFT_BGR
